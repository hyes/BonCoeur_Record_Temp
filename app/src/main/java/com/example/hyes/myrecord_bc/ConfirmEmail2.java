...
*/
public class ConfirmEmail2 extends ActionBarActivity{
...
//        Log.i("test", id+"");
    ...
    private void submit(){
        ...
        try {
            progressDialog = ProgressDialog.show(ConfirmEmail2.this, "", "업로드 중입니다.");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        Intent intent = new Intent(ConfirmEmail2.this, Intro.class);
