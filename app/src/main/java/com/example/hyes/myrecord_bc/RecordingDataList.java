...
public class RecordingDataList extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic5.setImageBitmap(loadCaptureView(record.getCaptureFile3()));
        pic6.setImageBitmap(loadCaptureView(record.getCaptureFile4()));
